      ...
      <div className="relative z-10">
        ...
        <nav className="border-b border-white/10 bg-[#020617]/60 backdrop-blur-xl sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            {!session ? (
              <Link href="/login" className="px-6 py-2 bg-white text-black rounded-full font-bold hover:bg-arena-mint transition-colors text-sm shadow-lg shadow-white/5">
                Sign In
              </Link>
            ) : (
              <Link href="/contests" className="px-6 py-2 bg-white/5 border border-white/10 rounded-full font-bold hover:bg-white/10 transition-all text-sm text-arena-blue">
                Go to Arena
              </Link>
            )}
          </div>
        ...
        <header className="relative pt-32 pb-40 px-6 text-center">
          <div className="max-w-5xl mx-auto animate-fadeIn relative z-10">
            ...
            <h1 className="text-6xl md:text-8xl font-bold mb-8 tracking-tight text-white drop-shadow-2xl">
              Code. Compete. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-arena-pink via-arena-blue to-arena-mint">Conquer.</span>
            </h1>
        ...
        <main className="max-w-7xl mx-auto px-6 space-y-64 pb-64 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative">
            <div className="space-y-6 order-2 lg:order-1 relative z-10">
              ...
              <h2 className="text-5xl font-bold tracking-tight text-white">Stream-Isolated Contests</h2>
              <p className="text-gray-400 text-lg leading-relaxed max-w-md font-medium">Timed challenges curated specifically for your technical stream to ensure relevance and fair play.</p>
            ...
            <div className="relative order-1 lg:order-2 group flex justify-center items-center min-h-[400px]">
              {/* WHITE BRACKETS */}
              <div className="absolute inset-0 flex justify-between items-center text-white/[0.18] text-[450px] font-mono select-none pointer-events-none z-0 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
              ...
              <div className="relative w-full max-w-sm h-full flex items-center justify-center">
                <img src="/contest-past.png" className="absolute w-40 rounded-xl border border-white/10 shadow-xl -rotate-12 -translate-x-32 opacity-40 group-hover:opacity-100 group-hover:z-30 transition-all duration-500" alt="Past" />
                <img src="/contest-upcoming.png" className="absolute w-40 rounded-xl border border-white/10 shadow-xl rotate-12 translate-x-32 opacity-40 group-hover:opacity-100 group-hover:z-30 transition-all duration-500" alt="Upcoming" />
                <div className="relative z-20 rounded-2xl border border-arena-mint/30 overflow-hidden shadow-2xl scale-110 group-hover:scale-115 transition-transform duration-500">
                   <img src="/contest-active.png" className="w-56 hero-img" alt="Active" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative">
            <div className="relative group flex justify-center">
              ...
              <div className="relative z-10 rounded-3xl border border-white/10 overflow-hidden shadow-2xl group-hover:border-arena-blue/30 transition-all max-w-md">
                <img src="/hero-editor.png" className="w-full hero-img transition-transform duration-700 group-hover:scale-105" alt="Editor" />
              </div>
            </div>
            <div className="space-y-6 relative z-10">
              <Badge icon={<Code2 size={16}/>} color="text-arena-blue" label="Pro IDE" />
              <h2 className="text-5xl font-bold tracking-tight text-white">Industrial Execution</h2>
              <p className="text-gray-400 text-lg leading-relaxed max-w-md font-medium">Lightning-fast code execution via Judge0 CE with human-readable error tracebacks instantly.</p>
            </div>
          </div>

          <Separator />

          {/* 3. LEADERBOARD -> ( ) Brackets */}
          <div className="grid lg:grid-cols-2 gap-20 items-center relative">
            <div className="space-y-6 order-2 lg:order-1 relative z-10">
              <Badge icon={<BarChart size={16}/>} color="text-arena-mint" label="Rankings" />
              <h2 className="text-5xl font-bold tracking-tight text-white">Fair Play Ranking</h2>
              <p className="text-gray-400 text-lg leading-relaxed max-w-md font-medium">Realtime Leaderboards that only count submissions solved within the live contest window.</p>
            ...
            <div className="relative order-1 lg:order-2 group flex justify-center">
              ...
              <div className="relative z-10 rounded-3xl border border-white/10 overflow-hidden shadow-2xl group-hover:border-arena-pink/30 transition-all max-w-md">
                <img src="/hero-leaderboard.png" className="w-full hero-img transition-transform duration-700 group-hover:scale-105" alt="Leaderboard" />
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative">
            <div className="relative group flex justify-center">
              ...
              <div className="relative z-10 rounded-3xl border border-white/10 overflow-hidden shadow-2xl group-hover:border-arena-blue/30 transition-all max-w-md">
                <img src="/hero-bank.png" className="w-full hero-img transition-transform duration-700 group-hover:scale-105" alt="Problem Bank" />
              </div>
            </div>
            <div className="space-y-6 relative z-10">
              <Badge icon={<Search size={16}/>} color="text-arena-blue" label="Library" />
              <h2 className="text-5xl font-bold tracking-tight text-white">Infinite Practice</h2>
              <p className="text-gray-400 text-lg leading-relaxed max-w-md font-medium">Explore 100+ LeetCode-style problems. Filter by Unattempted status to keep your growth consistent.</p>
            </div>
          </div>

          <Separator />

          {/* 5. DASHBOARD -> || Brackets */}
          <div className="grid lg:grid-cols-2 gap-20 items-center relative">
            <div className="space-y-6 order-2 lg:order-1 relative z-10">
              <Badge icon={<Layout size={16}/>} color="text-arena-pink" label="User Center" />
              <h2 className="text-5xl font-bold tracking-tight text-white">Track Progress</h2>
              <p className="text-gray-400 text-lg leading-relaxed max-w-md font-medium">Maintain daily streaks and visualize your growth with personalized statistics.</p>
            </div>
            <div className="relative order-1 lg:order-2 group flex justify-center">
              <div className="absolute inset-0 flex justify-between items-center text-white/[0.18] text-[450px] font-mono select-none pointer-events-none z-0 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
              ...
              <CurvedArrow className="absolute -bottom-24 right-10 text-arena-mint" rotation="rotate-[-160deg]" label="Personalised Analytics" />
              <div className="relative z-10 rounded-3xl border border-white/10 overflow-hidden shadow-2xl group-hover:border-arena-mint/30 transition-all max-w-md">
                <img src="/hero-dashboard.png" className="w-full hero-img transition-transform duration-700 group-hover:scale-105" alt="Dashboard" />
              </div>
            </div>
          </div>
        </main>
        ...
        <section className="py-40 bg-gradient-to-b from-transparent to-arena-pink/5 border-t border-white/10">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-5xl md:text-7xl font-bold mb-12 tracking-tight text-white">Ready to join the Arena?</h2>
            <Link href="/login" className="px-16 py-8 bg-white text-black font-bold rounded-2xl text-2xl hover:bg-arena-mint transition-all shadow-[0_20px_50px_rgba(255,255,255,0.1)] inline-block uppercase">
              Get Started Now
            </Link>
          </div>
        </section>
...
function Separator() {
  return <div className="h-px w-full bg-gradient-to-r from-transparent via-white/10 to-transparent mx-auto max-w-4xl opacity-50" />
}

function Badge({ icon, label, color }: { icon: any, label: string, color: string }) {
  return <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/5 ${color} font-bold text-[10px] uppercase tracking-widest backdrop-blur-sm`}>{icon} {label}</div>
}

function FeatureItem({ label }: { label: string }) {
  return <div className="flex items-center gap-3 text-gray-300"><div className="w-2 h-2 rounded-full bg-arena-mint shadow-md" /><span className="font-bold text-sm uppercase tracking-wider">{label}</span></div>
}
    ...
    <div className={`flex flex-col items-center pointer-events-none select-none z-30 ${className}`}>
      ...
      <div className={rotation}>
        <svg width="100" height="100" viewBox="0 0 80 80" fill="none">
          <path d="M10 10C35 10 70 30 70 70M70 70L55 65M70 70L65 55" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
    </div>
  )
